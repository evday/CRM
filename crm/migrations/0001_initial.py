# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-22 07:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_memo', models.TextField(blank=True, null=True, verbose_name='本节内容概要')),
                ...
                ('exam', models.TextField(blank=True, max_length=300, null=True, verbose_name='采分点')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('graduation_school', models.CharField(blank=True, max_length=32, null=True, verbose_name='毕业学校')),
                ('major', models.CharField(blank=True, max_length=32, null=True, verbose_name='所学专业')),
                ...
                ('work_status', models.IntegerField(blank=True, choices=[(1, '在职'), (2, '无业')], default=1, verbose_name='职业状态')),
                ...
                ('source', models.IntegerField(choices=[(1, 'qq群'), (2, '内部转介绍'), (3, '官方网站'), (4, '百度推广'), (5, '360推广'), (6, '搜狗推广'), (7, '腾讯课堂'), (8, '广点通'), (9, '高校宣讲'), (10, '渠道代理'), (11, '51cto'), (12, '智汇推'), (13, '网盟'), (14, 'DSP'), (15, 'SEO'), (16, '其它')], default=1, verbose_name='客户来源')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.IntegerField(null=True, unique=True, verbose_name='部门编号')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentRecord',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_contract', models.CharField(blank=True, max_length=32, verbose_name='紧急联系人')),
                ...
                ('date', models.DateTimeField(auto_now_add=True, help_text='格式yyyy-mm-dd', verbose_name='入职时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='提交作业时间')),
        ...
        migrations.AddField(
            ...
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='谁签的单就选谁', to='crm.UserInfo', verbose_name='负责老师'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='customer',
        ...
        migrations.AddField(
            model_name='customer',
            name='referral_form',
            field=models.ForeignKey(help_text='若此客户是转介绍自内部学员,请在此处选择内部学员姓名', on_delete=django.db.models.deletion.CASCADE, related_name='internal_referral', to='crm.Customer', verbose_name='转介绍学员'),
        ),
        migrations.AddField(
